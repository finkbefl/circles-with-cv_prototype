# A script for a first spike to estimate the poses with mediapipe during circles on the mushroom and analyze the distances between nose and feet
...
if __name__ == "__main__":
    ...
    save_data(csv_data_frame, "output/spike", "pose-estimation-distance.csv")
    ...
    file_name = "pose-estimation-distance.html"
